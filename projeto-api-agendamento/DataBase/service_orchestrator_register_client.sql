...
CREATE TABLE `register_client` (
  ...
  `Accessibility` varchar(150) DEFAULT NULL,
  ...
  KEY `register_client` (`id_Address`),
  CONSTRAINT `register_client` FOREIGN KEY (`id_Address`) REFERENCES `address` (`id`)
...
INSERT INTO `register_client` VALUES (254,'Nayan alves Moreira','Nayan.Alves@gmail.com','1191122-4973','NENHUMA',NULL,11,'CLIENT',1);
